...
LABELS_DIR = r"D:\BEL\my_dataset\animal_labels\labels_val"
IMAGES_DIR = r"D:\BEL\my_dataset\animal_images\images_val"
CLASSES_FILE = os.path.join(LABELS_DIR, "classes.txt")
REPORT_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "label_report_val.txt")
# -------------------------------------------------
